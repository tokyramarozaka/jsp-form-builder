...
<body>
    ...
    <main>
        ...
        <section>
            ...
            <div class="user-list">
                <% if (doctors.isEmpty()) {
                       out.println("There are no doctors yet");
                   } else {%>
                    <% for (Doctor doctor : doctors) { %>
                        <div class="user-card">
                            <div class="user-actions">
                                <a class="icon-link" href="form.jsp?className=model.Doctor&id=<%= doctor.getId() %>" title="Edit">✏️ Edit</a>
                                <form method="POST" action="deleteUser.jsp" class="inline-form">
                                    <input type="hidden" name="id" value="<%= doctor.getId() %>">
                                    <button type="submit" class="icon-link" title="Delete">🗑️ Delete</button>
                                </form>
                            </div>
        ...
        <section>
            ...
            <div class="user-list">
                <% if (patients.isEmpty()) {
                       out.println("There are no patient yet");
                   } else { %>
                    <% for (Patient patient : patients) { %>
                        <div class="user-card">
                            <div class="user-actions">
                                <a class="icon-link" href="form.jsp?className=model.Patient&id=<%= patient.getId() %>" title="Edit">✏️ Edit</a>
                                <form method="POST" action="deleteUser.jsp" class="inline-form">
